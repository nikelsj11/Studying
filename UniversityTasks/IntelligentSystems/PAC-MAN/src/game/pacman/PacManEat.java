...
public class PacManEat {
	...
	// the ghostActors it controls
	GhostActor[] ghostActors;
	...
	PacManEat(Window a, Graphics g, GhostActor[] gh) {
		applet=a;
		graphics=g;
		ghostActors =gh;
		...
		ImageData.drawPowerDot(imagePowerDot);
